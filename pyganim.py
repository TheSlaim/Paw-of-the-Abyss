# Без цього файлу бібліотека pyganim не працює.
# Pyganim - це доповнення(модуль) для pygame, щоб створювати анімацію для спрайта (я її використав для анімації гравця).
# https://pypi.org/project/Pyganim/
